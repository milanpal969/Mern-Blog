...
export default function Header() {
  ...
  return (
    <Navbar className='border-b-2 ' >
        ...
        {/* <form> */}
        <TextInput type='text' className='hidden lg:inline' placeholder='Search' rightIcon={AiOutlineSearch}/>
        {/* </form> */}
        <Button className='w-12 h-10 lg:hidden'  color='gray' lg:hidden pill>
        <AiOutlineSearch/>
        </Button>
